...
use crate::memory::value::{AppClosure, Value};

pub fn eval_term<'arena>(
    values: Vec<Value<'arena>>,
    term: Term<'arena>,
    ...
    match *term {
        ...
        App(fun, arg) => {
            ...
            match *fun {
                ...
                crate::memory::value::Payload::Abs(_, ref body) => {
        ...
        Decl(d) => Ok(Value::decl(d, arena)),
        Axiom(ax, l) => Ok(Value::neutral(crate::memory::value::Head::Axiom(ax, l), Vec::new(), arena)),
    }
}
