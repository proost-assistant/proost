...
mod tests {
    ...
    fn simple_subst() {
        ...
        let term = Abs("".into(),
            box Prop,
            box App(
                box Abs("".into(),box Prop, box App(box Var(2.into()), box Var(1.into()))),
                box Var(1.into()),
            ),
        );

        // λx.x x
        let reduced = Abs("".into(),box Prop, box App(box Var(1.into()), box Var(1.into())));
    ...
    fn complex_subst() {
            ...
            box Abs("".into(),
                ...
                box App(
                    box Abs("".into(),
                        ...
                        box App(
                            box Var(1.into()),
                            box App(box Abs("".into(),box Prop, box Var(3.into())), box Var(3.into())),
                        ),
                    ),
                    box Abs("".into(),box Prop, box Var(1.into())),
                ),
        ...
        let term_step_5 = Abs("".into(),
            box Prop,
            box Abs("".into(),
                box Prop,
                box App(
                    box Abs("".into(),box Prop, box Var(1.into())),
                    box App(box Abs("".into(),box Prop, box Var(2.into())), box Var(2.into())),
                ),
            ),
        );

        let term_step_6 = Abs("".into(),
            box Prop,
            box Abs("".into(),
                box Prop,
                box App(box Abs("".into(),box Prop, box Var(2.into())), box Var(2.into())),
        ...
        // λa.λb.b
        let term_step_7 = Abs("".into(),box Prop, box Abs("".into(),box Prop, box Var(1.into())));
